import {  BriefcaseBusiness, Globe,  Mail, MapPin, Network, Phone, User } from 'lucide-react'
import React from 'react'

const PersonalInfoFrom = ({data, onChange, removeBackground, setRemoveBackground}) => {
    ...
    const fields = [
        ...
        { key: "linkedin", label: "LinkedIn Profile", icon: Network, type: "url" },
    ...
    <div>
      ...
      <div className='flex items-center gap-2'>
        <label>
            ...
            <input type="file"  accept='image/jpeg , image/png' className='hidden' onChange={(e)=>handleChnage("image", e.target.files[0])}/>
        </label>
